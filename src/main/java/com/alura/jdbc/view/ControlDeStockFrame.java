    ...
    private void modificar() {
        ...
        Optional.ofNullable(modelo.getValueAt(tabla.getSelectedRow(), tabla.getSelectedColumn()))
                .ifPresentOrElse(fila -> {
                    ...
                    Integer cantidad = Integer.valueOf(String.valueOf(modelo.getValueAt(tabla.getSelectedRow(), 3)));
                    ...
                    /**
                     * Llama a la funcion del controlador
                     */
                    filasModificadas = this.productoController.modificar(producto);


                    JOptionPane.showMessageDialog(this, filasModificadas + " fila(s) modificadas con éxito");
                }, () -> JOptionPane.showMessageDialog(this, "Por favor, elije un item"));
    }
    ...
    private void eliminar() {
        ...
        Optional.ofNullable(modelo.getValueAt(tabla.getSelectedRow(), tabla.getSelectedColumn()))
                .ifPresentOrElse(fila -> {
                    ...
                    filasEliminadas = this.productoController.eliminar(id);

                    modelo.removeRow(tabla.getSelectedRow());

                    JOptionPane.showMessageDialog(this, filasEliminadas + "Item(s) eliminados con éxito!");
                }, () -> JOptionPane.showMessageDialog(this, "Por favor, elije un item"));
    }
